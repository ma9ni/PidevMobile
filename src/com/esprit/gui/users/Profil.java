...
public class Profil extends Bar {
    ...
    public Profil(){
        super();
         ...
         Image i = (URLImage.createToStorage(enc, User.getUserConncter().getUsername(), "http://localhost/pi/pi_dev/web/uploads/images/" +User.getUserConncter().getImage()+ "", URLImage.RESIZE_SCALE));
