 ...
 * @author salah
 */
public class AjouterAnimal extends Bar {

    public AjouterAnimal() {
        super();
        this.hi.setTitle("Ajouter un Animal");
        //pour le titre de l'accessoire
        Label titreLabel = new Label("Nom");
        TextField titreArea = new TextField("", "Nom", 12, TextArea.ANY);
        Label titreEror = new Label("*");
        ...
        vlaiderButton.addActionListener((evt) -> {
            ...
            temps.setDatedenaissance(datepiker.getDate());
            animalservices aaaa = new animalservices();
            aaaa.ajouterGateau(temps);
            Dialog.show("felicitation", " votre animaal et mossab", "ok", null);
