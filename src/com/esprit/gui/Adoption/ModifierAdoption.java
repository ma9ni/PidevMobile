...
public class ModifierAdoption extends Bar{
    ...
    public ModifierAdoption(Adoption adoption){
         ...
         Image i = (URLImage.createToStorage(enc, adoption.getIdAnimal().getNom(), "http://localhost/pi/pi_dev/web/upload/images/" + adoption.getIdAnimal().getImage() + "", URLImage.RESIZE_SCALE));
