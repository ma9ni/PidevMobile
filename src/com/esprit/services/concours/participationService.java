...
public class participationService {
    ...
    public void ajoutparticip(participer p) {
        ...
        String Url = ToolsUtilities.UrlAhmedMakni + "Concours/mobile/sub?concour=" + p.getIdconcour() + "&animal=" + p.getIdanimal();
        con.setUrl(Url);
    ...
    public ArrayList<animal> getListTask(String json) {
        ...
        try {
            ...
            for (Map<String, Object> obj : list) {
                ...
                Map<String, Object> animalmembre = (Map<String, Object>) obj.get("idMembre");
...
// System.out.println(id);
    ...
    public ArrayList<animal> getList2() {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "Concours/mobile/allanimal");
