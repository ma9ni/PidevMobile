...
public class animalsusersevices {
    ...
    public void ajoutTask(animal an) {
        ...
        String Url = ToolsUtilities.UrlAhmedMakni + "tasks/" + an.getNom() + "/" + an.getDescription();
        con.setUrl(Url);
...
//            }
    ...
    public ArrayList<animal> getList2() {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "allanimal/" + User.getIdOfConnectedUser());
    ...
    public void modifier_animal(animal an) {
        ...
        String Url = ToolsUtilities.UrlAhmedMakni + "animal/edit?" + "id=" + an.getId() + "&description=" + an.getDescription() + "&nom=" + an.getNom();
        con.setUrl(Url);
