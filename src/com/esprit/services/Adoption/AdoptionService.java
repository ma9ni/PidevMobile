...
public class AdoptionService {
    ...
    public ArrayList<Adoption> getList2() {
        ...
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "allAdoption");
    ...
    public void AjouterAdoption(Adoption adoption) {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "AjoutAdoption_mobile?description="
    ...
    public ArrayList<animal> getListanimal2() {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "listeAnimalUserMobile/" + User.getUserConncter().getId());
...
//}
    public void ajoutReclamation(int idAdoption, String Sujet, String message) {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "AjoutReclamation?idAdoption=" + idAdoption
    ...
    public void SupprimerAdoption(int id) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "SuppAdoptionnn/" + id);
        con.addResponseListener((e) -> {
            //String str = new String(con.getResponseData());
        });
        NetworkManager.getInstance().addToQueueAndWait(con);
    ...
    public void modifierAdoption(Adoption adoption) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(ToolsUtilities.UrlAhmedMakni + "ModifierAdoption?id=" + adoption.getIdAdoption()
